...
CVE_post = CVE(title='Saving CVE', content='First Saving command', date_published=datetime.utcnow(),author=Abdelrahim).save()

CPE_post = CPE(title='Saving CPE',content='First Saving command',date_published=datetime.utcnow(),author=Marcel).save()